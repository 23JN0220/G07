...
namespace ClassLibrary
{
    public class CpuChipsetSeriesTable
    {
        ...
        public int Delete(int goods_code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                string sql = "DELETE FROM CPU_ChipsetSeries WHERE goods_code = @goods_code";
        ...
        public DataTable GetCpuChipsetSeries()
        {
            DataTable table = new DataTable();
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                string sql = "SELECT * FROM CPU_ChipsetSeries";
                SqlDataAdapter adapter = new SqlDataAdapter(sql, connection);
        ...
        public int Insert2(string series_name)
        {
            int ret = 0;
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                string sql = "INSERT INTO CPU_ChipsetSeries () VALUES (@series_name)";
