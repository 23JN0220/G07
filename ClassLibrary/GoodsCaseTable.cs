...
namespace ClassLibrary
{
    public class GoodsCaseTable
    {
        ...
        public int Delete(int goods_code)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                string sql = "DELETE FROM Goods_Case WHERE goods_code = @goods_code";
        ...
        public DataTable GetGoodsCaseByPowerSizeId(int power_size_id)
        {
            DataTable table = new DataTable();
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                string sql = "SELECT Goods.goods_code, goods_name FROM Goods INNER JOIN Goods_Case ON Goods.goods_code = Goods_Case.goods_code WHERE power_size_id = @power_size_id";

                SqlDataAdapter adapter = new SqlDataAdapter(sql, connection);
                adapter.SelectCommand.Parameters.AddWithValue("@power_size_id", power_size_id);
        ...
        public DataTable GetGoodsCaseBySizeId(int fan_size_id)
        {
            DataTable table = new DataTable();
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                string sql = "SELECT Goods.goods_code, goods_name FROM Goods INNER JOIN Goods_Case ON Goods.goods_code = Goods_Case.goods_code WHERE fan_size_id = @fan_size_id";

                SqlDataAdapter adapter = new SqlDataAdapter(sql, connection);
                adapter.SelectCommand.Parameters.AddWithValue("@fan_size_id", fan_size_id);
